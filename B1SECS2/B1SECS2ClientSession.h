...
namespace BnD {
    ...
    public:
        B1SECS2ClientSession(B1ClientSocket* clientSocket, B1BaseClientSessionListener* listener, uint16 secs2SessionID);
    protected:
        enum CONSTS {
    ...
    protected:
        ...
        bool sendMessageS1F1(uint16 sessionID, const std::vector<uint8>& systemBytes);
    ...
    protected:
        ...
        virtual void onRecvMessageS1F2(uint16 sessionID, const std::vector<uint8>& systemBytes, const B1SECS2DataMDLN& mdln, const B1SECS2DataSOFTREV& softRev) {}
        virtual void onRecvMessageS1F4(uint16 sessionID, const std::vector<uint8>& systemBytes, const std::vector<B1SECS2DataSV>& svs) {}
        virtual void onRecvMessageS1F14(uint16 sessionID, const std::vector<uint8>& systemBytes,
                                        const B1SECS2DataCOMMACK& commAck, const B1SECS2DataMDLN& mdln, const B1SECS2DataSOFTREV& softRev) {}
        virtual void onRecvMessageS1F16(uint16 sessionID, const std::vector<uint8>& systemBytes, const B1SECS2DataOFLACK& oflAck) {}
        virtual void onRecvMessageS1F18(uint16 sessionID, const std::vector<uint8>& systemBytes, const B1SECS2DataONLACK& onlAck) {}
        virtual void onRecvMessageS2F0(uint16 sessionID, const std::vector<uint8>& systemBytes) {}
        virtual void onRecvMessageS2F32(uint16 sessionID, const std::vector<uint8>& systemBytes, const B1SECS2DataTIACK& tiAck) {}
        virtual void onRecvMessageS2F34(uint16 sessionID, const std::vector<uint8>& systemBytes, const B1SECS2DataDRACK& drAck) {}
        virtual void onRecvMessageS2F36(uint16 sessionID, const std::vector<uint8>& systemBytes, const B1SECS2DataLRACK& lrAck) {}
        virtual void onRecvMessageS2F38(uint16 sessionID, const std::vector<uint8>& systemBytes, const B1SECS2DataERACK& erAck) {}
        virtual void onRecvMessageS2F42(uint16 sessionID, const std::vector<uint8>& systemBytes,
                                        const B1SECS2DataHCACK& hcAck, const std::map<B1SECS2DataCPNAME, B1SECS2DataCPACK>& cps) {}
        virtual void onRecvMessageS2F50(uint16 sessionID, const std::vector<uint8>& systemBytes,
        ...
        virtual void onRecvMessageS5F4(uint16 sessionID, const std::vector<uint8>& systemBytes, const B1SECS2DataACKC5& ackc5) {}
        ...
        virtual void onRecvMessageS64F2(uint16 sessionID, const std::vector<uint8>& systemBytes,
                                        const B1SECS2DataHCACK& hcAck, const std::map<B1SECS2DataCPNAME, B1SECS2DataCPACK>& cps) {}
    protected:
