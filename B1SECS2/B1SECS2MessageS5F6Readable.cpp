//
// B1SECS2MessageS5F6Readable.cpp
//
// Library: B1SECS2
// Package: S5
// Module:  B1SECS2
...
#include "B1SECS2.h"
#include "B1SECS2MessageS5F6Readable.h"

using namespace BnD;

B1SECS2MessageS5F6Readable::B1SECS2MessageS5F6Readable(bool wait, const uint8* data, uint32 dataLength, const B1SECS2DataManager* dataManager)
    : B1SECS2MessageReadable(wait, 5, 6, "recvMessageS5F6", data, dataLength, dataManager)
    , _internalData()
{
}

B1SECS2MessageS5F6Readable::~B1SECS2MessageS5F6Readable()
{
}

B1String B1SECS2MessageS5F6Readable::fullName()
{
    return "List Alarm Data (LAD)";
}

void B1SECS2MessageS5F6Readable::implToString(B1String* string)
{
...
bool B1SECS2MessageS5F6Readable::implReadData()
{
