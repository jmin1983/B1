//
// B1SECS2MessageS6F16Readable.cpp
//
// Library: B1SECS2
// Package: S6
// Module:  B1SECS2
...
#include "B1SECS2.h"
#include "B1SECS2MessageS6F16Readable.h"

using namespace BnD;

B1SECS2MessageS6F16Readable::B1SECS2MessageS6F16Readable(bool wait, const uint8* data, uint32 dataLength, const B1SECS2DataManager* dataManager)
    : B1SECS2MessageReadable(wait, 6, 16, "recvMessageS6F16", data, dataLength, dataManager)
    , _dataID(dataManager)
    , _ceID(dataManager)
    , _reportsData()
{
...
B1SECS2MessageS6F16Readable::~B1SECS2MessageS6F16Readable()
{
}

B1String B1SECS2MessageS6F16Readable::fullName()
{
    return "Event Report Data (ERD)";
}

void B1SECS2MessageS6F16Readable::implToString(B1String* string)
{
...
bool B1SECS2MessageS6F16Readable::implReadData()
{
