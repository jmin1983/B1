...
#ifndef _B1SECS2_MESSAGE_S5F6_READABLE_H
#define _B1SECS2_MESSAGE_S5F6_READABLE_H
...
namespace BnD {
    class B1SECS2MessageS5F6Readable : public B1SECS2MessageReadable {
    public:
        B1SECS2MessageS5F6Readable(bool wait, const uint8* data, uint32 dataLength, const B1SECS2DataManager* dataManager);
        virtual ~B1SECS2MessageS5F6Readable();
    protected:
        struct InternalData {
...
#endif  // !_B1SECS2_MESSAGE_S5F6_READABLE_H
