...
#ifndef _B1SECS2_MESSAGE_S6F16_READABLE_H
#define _B1SECS2_MESSAGE_S6F16_READABLE_H
...
namespace BnD {
    class B1SECS2MessageS6F16Readable : public B1SECS2MessageReadable {
    public:
        B1SECS2MessageS6F16Readable(bool wait, const uint8* data, uint32 dataLength, const B1SECS2DataManager* dataManager);
        virtual ~B1SECS2MessageS6F16Readable();
    protected:
...
#endif  // !_B1SECS2_MESSAGE_S6F16_READABLE_H
