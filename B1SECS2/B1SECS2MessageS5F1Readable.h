...
#ifndef _B1SECS2_MESSAGE_S5F1_READABLE_H
#define _B1SECS2_MESSAGE_S5F1_READABLE_H
...
namespace BnD {
    class B1SECS2MessageS5F1Readable : public B1SECS2MessageReadable {
    public:
        B1SECS2MessageS5F1Readable(bool wait, const uint8* data, uint32 dataLength, const B1SECS2DataManager* dataManager);
        virtual ~B1SECS2MessageS5F1Readable();
    protected:
...
#endif  // !_B1SECS2_MESSAGE_S5F1_READABLE_H
